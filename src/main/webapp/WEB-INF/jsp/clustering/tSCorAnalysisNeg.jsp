    ...
    <div id="center">
        ...
        <table id="expTableforPara" cellpadding="5" class="expTableforPara">
            ...
            <%--<tr>--%>
                ...
                <%--</td>--%>
                <%--<td colspan="2">--%>
                    <%--<label style="padding-right: 120px"><input id = "HCN" name="radio2Name" type="radio" onclick="radioControl(this.name);$('#algorithm').val('HCN')">层次聚类</label>--%>
                    <%--<label style=""><input id = "DCN" name="radio2Name" type="radio" onclick="radioControl(this.name);$('#algorithm').val('DCN')">密度聚类</label>--%>
                <%--</td>--%>
            <%--</tr>--%>
            <tr>
                <td>
