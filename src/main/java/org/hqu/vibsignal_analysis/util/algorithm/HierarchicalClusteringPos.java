...
public class HierarchicalClusteringPos {
    static int size1;
    static int size2;
    static int windowSize;
    static int label=1;
    static WebSocketSession session;
    public ExpResult hcp(WebSocketSession webSocketSession, HttpSession httpSession, double correlation, int windowSize, int clusterSize, String filePath1, String filePath2, String dataId)throws Exception {
        ...
        String fileName = "HClusteringPosResult" + DateConverter.parseDateString(new Date(),"yyyyMMddHHmmss") +".txt";
        ...
        httpSession.setAttribute("HCP",sessionList);
        //填充试验结果对象参数部分
