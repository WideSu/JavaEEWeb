...
<form:form id="experiment" modelAttribute="experiment" action="${ctx}/save" method="post" target="hidden_frame_add">
    ...
    <div id="center">
        ...
        <div id="resultData"  style="padding:10px">
            ...
            <div align="right">
                <a href="javascript:void(0)" class="easyui-linkbutton" style="margin-top: 37px;" onclick="downloadFile()" text="下载"></a>
            </div>
        </div>
        ...
        <table id="expTableforPara" cellpadding="5" class="expTableforPara">
            ...
            <tr>
                ...
                <td>
                    <textarea id="alOutput" rows="5" cols="20" class="textAreaCss" readonly="true"></textarea>
                </td>
            </tr>
            <tr>
                <td colspan="2" align="center">
                    <div style="">
                        <a id="checkPic" href="javascript:void(0)" class="easyui-linkbutton" style="color: #439eb7" onclick="$('#resultPic').dialog('open');">查看结果图</a>
                        <a id="checkData" href="javascript:void(0)"  style="margin-left:50px;color: #439eb7;" class="easyui-linkbutton" onclick="$('#resultData').dialog('open');">查看结果数据</a>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <script>
        ...
        */
        ...
        function runAlgorithms(){
            ...
            socket.onopen = function(event){
                var str = 'expClass='+expClass
                    +'&freqRangeMin='+param1+'&freqRangeMax='+param2+'&samplingFreq='+param3+'&p2Predict='+param4
        ...
        function butonSaveUpload(){
            ...
            //训练数据;未知测点数据；待预测数据
            var str = ['knownPoint=Tdata', 'unKnownPoint=Pdata', 'data2Predict=Udata'];
