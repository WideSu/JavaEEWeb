    ...
    <div id="center">
        ...
        <table id="expTableforPara" cellpadding="5" class="expTableforPara">
            <tr>
                ...
                <td>
                    <div id="radioDiv1" style="">
                        <a href="javascript:void(0)" style="" class="easyui-linkbutton" onclick="$('#chooseUploadData').window('open');">上传</a>
                    </div>
                    <div id="textDiv" style="">
                        <label>时间序列1：<div id = 'kText' style="display: table-row"></div></label>
                        <br/>
                        <div style="margin-top: 5px">
                            <label>时间序列2：<div id = 'uText' style="display: table-row"></div></label>
                        </div>
            ...
            <tr>
                ...
                <td>
                    <input id="corThreshold" cssClass="textbox" name="corThreshold" class="textbox" onkeyup="onlyNum(this)" style="width: 15%;height:25px;font-size: 15px"/>
                </td>
            </tr>
            <tr>
            ...
            <%--<tr>--%>
                <%--<td style="padding-top: 25px;padding-bottom: 25px;">--%>
                    <%--<label>时间序列聚类方法：</label>--%>
                    <%--<input id="algorithm" type="hidden" name="algorithm">--%>
                <%--</td>--%>
                <%--<td colspan="2">--%>
                    <%--<label style="padding-right: 120px"><input id = "HCP" name="radio2Name" type="radio" onclick="radioControl(this.name);$('#algorithm').val('HCP')">层次聚类</label>--%>
                    <%--<label style=""><input id = "DCP" name="radio2Name" type="radio" onclick="radioControl(this.name);$('#algorithm').val('DCP')">密度聚类</label>--%>
                <%--</td>--%>
            <%--</tr>--%>
            <tr>
                <td>
        ...
        */
        ...
        function runAlgorithms(){
            ...
            socket.onopen = function(event){
                var str = $('#timeSeries').serialize() + '&sessionId=<%= session.getId() %>';
                socket.send(str);
                //清空流动文本
                textflow=[];
            }
        ...
        $('#buttonSave').click(function(){
            ...
            '&param2='+ str[1] + '&expId=' + 'clustering' + '&expClass=' + $('#expClass').val();
