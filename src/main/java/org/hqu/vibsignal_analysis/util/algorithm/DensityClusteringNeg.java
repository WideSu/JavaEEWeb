...
public class DensityClusteringNeg {
    static int size1;
    static int size2;
    static int windowSize=24;
    static int label=1;
    static WebSocketSession session;
    public ExpResult dcn(WebSocketSession webSocketSession, HttpSession httpSession, double correlation, int windowSize, int clusterSize, String filePath1, String filePath2, String dataId) throws Exception {
        this.session = webSocketSession;
        this.windowSize =windowSize;
        double N = correlation;
        DensityClusteringNeg hc = new DensityClusteringNeg();
        // 使用链表存放样本点
        ...
        String fileName = "DClusteringNegResult" + DateConverter.parseDateString(new Date(),"yyyyMMddHHmmss") +".txt";
        ...
        httpSession.setAttribute("DCN",sessionList);
        //填充试验结果对象参数部分
