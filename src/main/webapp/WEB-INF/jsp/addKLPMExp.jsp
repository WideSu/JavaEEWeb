...
<form:form id="experiment" modelAttribute="experiment" action="${ctx}/save" method="post" target="hidden_frame_add">
    ...
    <div id="center">
        <div id="chooseUploadData" class="easyui-window" title="选择上传文件" data-options="modal:true,iconCls:'icon-save',closed:true,${windowsProperties}" style="overflow:hidden;width:366px;height:273px;padding:10px;">
            <input type="file" id="knownLoadFile"  name="upload" onchange="validDateFileNew(this,'#fileName1')" style="display: none"/>
            <input type="file" id="knownResponseFile" name="upload" onchange="validDateFileNew(this,'#fileName2')" style="display: none"/>
            <table cellpadding="20" class="fileUploadTable">
                <tr>
                    ...
                    <td>
                        <a class="easyui-linkbutton" onclick="$('#knownLoadFile').click()">上传</a>
                ...
                <tr>
                    ...
                    <td>
                        <a class="easyui-linkbutton" onclick="$('#knownResponseFile').click()">上传</a>
                        <label id="fileName2">请选择文件</label>
                    </td>
                </tr>
            </table>
            <div id="buttons" style="align:center" class="button-arrange">
                <button id="buttonSave" type="button" class="easyui-linkbutton" onclick="" style="margin-right: 37px;">保存</button>
        ...
        <table id="expTableforPara" cellpadding="5" class="expTableforPara">
            ...
            <tr>
                <td colspan="2" align="center">
                    <div style="">
                        <a id="checkPic" href="javascript:void(0)" class="easyui-linkbutton" style="color: #439eb7" onclick="$('#resultPic').dialog('open');" text="&nbsp查看对比图&nbsp"></a>
        ...
        */
        ...
        function runAlgorithms(){
            ...
            socket.onopen = function(event){
                var str = 'expClass='+expClass+'&freqRangeMin='+param1+'&freqRangeMax='+param2+'&samplingFreq='+param3+'&p2Predict='+'null'+'&expId='+expId+'&dataId='+dataId+'&algorithm='+algorithm;
                socket.send(str);
                //清空流动文本
                textflow=[];
            };
        ...
        $('#buttonSave').click(function(){
            ...
            var file1 = $('#knownLoadFile').prop('files');
            var file2 = $('#knownResponseFile').prop('files');
            ...
            var str = ['knownLoad=Tdata', 'knownResponse=Pdata'];
        ...
        function showUploaded(selectedRow){
            ...
            $('#radioDiv2').css('display','none');
            $('#textDiv').css('display','block');
            $('#kText').html(selectedRow.knownLoad);
            $('#uText').html(selectedRow.knownResponse);
